...
const Clothes: React.FC<ClothesProps> = ({ type, color }) => {
  switch (type) {
    case "blazer":
      return (
        <g>
          <path fill={color} d="M284 360l0 -13c0,-45 -34,-83 -99,-87l-1 -1c-2,0 -4,0 -6,0 1,0 1,1 1,1l-1 0 1 0c0,2 0,3 0,5l-3 2c-24,23 -48,23 -72,0l-3 -2c0,-2 0,-4 1,-6 -2,0 -4,0 -6,0l-1 1c-65,4 -99,42 -99,87l0 13 74 0 19 0 62 0 19 0 74 0z" />
        </g>
      );
    case "sweater":
      return (
