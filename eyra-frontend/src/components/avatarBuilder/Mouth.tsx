...
const Mouth: React.FC<{ type: string }> = ({ type }) => {
  switch (type) {
    ...
    case "twinkle":
      return (
        <g>
          <path fill="#000000" fillRule="nonzero" d="M152 193c-1,-2 0,-3 2,-3 1,-1 3,0 3,1 1,3 2,5 5,6 2,2 5,3 8,3 3,0 6,-1 8,-3 3,-1 4,-3 5,-6 0,-1 2,-2 3,-1 2,0 3,1 2,3 -1,3 -4,6 -7,9 -3,2 -7,3 -11,3 -4,0 -8,-1 -11,-3 -3,-3 -6,-6 -7,-9z" />
        </g>
      );
    case "tongue":
      return (
        <g>
          <path fill="#000000" d="M160 213c17,0 31,-10 31,-23l-62 0c0,13 14,23 31,23z" />
          <path fill="#FEFEFE" d="M179 189l-38 0 0 2c0,3 2,5 4,5l30 0c2,0 4,-2 4,-5l0 -2z" />
          <path fill="#FF4F6D" d="M174 213c0,8 -6,15 -14,15 -8,0 -14,-7 -14,-15l0 -7c0,-4 4,-8 8,-8 3,0 5,1 6,2 1,-1 3,-2 6,-2 4,0 8,4 8,8l0 7z" />
        </g>
      );
    case "smile":
      return (
