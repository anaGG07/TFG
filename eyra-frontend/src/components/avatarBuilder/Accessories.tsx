...
const Accessories: React.FC<AccessoriesProps> = ({
  ...
  switch (type) {
    case "earphones":
      return (
        <>
          {/* Auriculares - traducido del SVG original a_earphones */}
          <path
            fill={color}
    ...
    case "earring1":
      return (
        <>
          {/* Pendiente tipo 1 - traducido del SVG original a_earring1 */}
          <path
            fill="#2B2A29"
            fillRule="nonzero"
    ...
    case "earring2":
      return (
        <>
          {/* Pendiente dorado circular - traducido del SVG original a_earring2 */}
    ...
    case "earring3":
      return (
        <>
          {/* Pendiente colgante azul - traducido del SVG original a_earring3 */}
          <path
            fill="#57A7B3"
            fillRule="nonzero"
