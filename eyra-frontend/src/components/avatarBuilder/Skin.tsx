...
const Skin: React.FC<SkinProps> = ({ color }) => {
  return (
    <g id="skin">
      ...
      <path id="neck" fill="#000000" fillOpacity="0.2" d="M160 256c-11,0 -21,-2 -30,-6l0 -12c9,5 19,7 30,7l0 0c11,0 21,-2 30,-7l0 12c-9,4 -19,6 -30,6z" />
      {/* Sombra de la nariz centrada */}
      <path id="nose" fill="#000000" fillOpacity="0.2" d="M160 181c9,0 16,-4 16,-9l-32 0c0,5 7,9 16,9z" />
    </g>
  );
};
