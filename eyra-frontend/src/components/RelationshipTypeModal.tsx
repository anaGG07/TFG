...
const RelationshipTypeModal: React.FC<RelationshipTypeModalProps> = ({
  ...
  const [selectedType, setSelectedType] = useState<"partner" | "parental" | "friend" | "healthcare_provider">("friend");
  ...
  const relationshipTypes = [
    ...
    { 
      ...
      permissions: ["view_cycle", "view_symptoms", "view_moods", "view_predictions"]
    },
    { 
      ...
      permissions: ["view_cycle", "view_symptoms", "view_analytics", "view_predictions"]
    },
    { 
      value: "parental", 
  ...
  const getSelectedTypeData = () => {
    const selected = relationshipTypes.find(type => type.value === selectedType);
  ...
  return (
    ...
    >
      ...
      {/* Modal */}
      <div className="relative bg-[#360001] rounded-3xl p-8 w-full max-w-lg mx-4 shadow-2xl pointer-events-auto">
        {/* Botón cerrar */}
        <button
          type="button"
          onClick={handleClose}
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pointer-events-auto">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center space-x-2 mb-1">
                      <span className="text-[#E7E0D5] font-semibold">{type.label}</span>
                      {selectedType === type.value && (
                        <span className="text-green-400 text-lg">✓</span>
                      )}
                    </div>
                    <p className="text-[#E7E0D5]/80 text-sm mb-2">{type.description}</p>
          ...
          <div className="bg-[#E7E0D5]/10 rounded-lg p-4">
            ...
            <p className="text-[#E7E0D5]/80 text-sm mb-2">
